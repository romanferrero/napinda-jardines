...
export default function Team() {
  return (
    <section id="nosotras" className="py-20 md:py-28 bg-bone">
      <Container>
        <SectionTitle
          eyebrow="Nosotras"
        ...
        <div className="mt-10 md:mt-14 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 max-w-3xl mx-auto">
          {team.map((person, idx) => (
            <FadeIn key={person.id} delay={idx * 0.1}>
              <article className="group">
                <div className="aspect-[3/4] sm:aspect-[4/5] rounded-2xl overflow-hidden bg-leaf-100">
                  <img
                    src={person.photo}
                    alt={person.name}
                    loading="lazy"
                ...
                <h3 className="font-display text-xl sm:text-2xl mt-4 sm:mt-5">{person.name}</h3>
